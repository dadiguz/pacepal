...
private let _tutorial: [String: [AppLang: String]] = [
    ...
    "tutorial.km_body":      [.es: "Cada km suma %d%% de energía. El anillo se llena conforme te acercas al mínimo diario de tu nivel — complétalo para marcar el día ✓",
                              .en: "Each km adds %d%% energy. The ring fills as you approach your level's daily minimum — complete it to mark the day ✓"],
