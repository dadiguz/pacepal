...
private let _charSelect: [String: [AppLang: String]] = [
    ...
    "char_select.name_profanity":  [.es: "No le gustó ese nombre",           .en: "It didn't like that name"],
...
private let _tutorial: [String: [AppLang: String]] = [
    ...
    "tutorial.hearts_title": [.es: "Tus vidas",    .en: "Your lives"],
    "tutorial.hearts_body":  [.es: "Tienes %d corazones. Pierdes uno por cada día que no corres. Si llegas a 0 tu compañero se agota y tendrás que elegir uno nuevo.",
                              .en: "You have %d hearts. You lose one for each day you don't run. If you reach 0 your companion collapses and you'll have to choose a new one."],
    "tutorial.km_title":     [.es: "Kilómetros",    .en: "Kilometers"],
    "tutorial.km_body":      [.es: "Cada km suma %d%% de energía. El anillo muestra cuánto te falta para el mínimo del día. Complétalo y el día queda marcado ✓",
                              .en: "Each km adds %d%% energy. The ring shows how close you are to your daily minimum. Fill it and the day is marked ✓"],
    "tutorial.km_body_hearts": [.es: "Corre al menos el mínimo del día para ganar un corazón. El anillo muestra tu progreso. Complétalo y el día queda marcado ✓",
                                .en: "Run at least the daily minimum to earn a heart. The ring shows your progress. Fill it and the day is marked ✓"],
